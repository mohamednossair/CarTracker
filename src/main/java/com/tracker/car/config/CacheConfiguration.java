package com.tracker.car.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tracker.car.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tracker.car.repository.UserRepository.USERS_BY_EMAIL_CACHE);
